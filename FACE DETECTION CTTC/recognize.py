...
classifier = cv2.CascadeClassifier(r"C:\Users\asus\Desktop\FACE DETECTION CTTC\FACE DETECTION CTTC\haarcascade_frontalface_default.xml")

model = load_model(r"C:\Users\asus\Desktop\FACE DETECTION CTTC\FACE DETECTION CTTC\final_model.h5")

URL = 'http://192.0.0.4:8080/shot.jpg'

def get_pred_label(pred):
    labels = ["Kappa", "Mohit", "Pooza"]
    return labels[pred]
